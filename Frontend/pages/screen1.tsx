...
const Screen1: NextPage = () => {
    ...
    return (
        <div className="bg-white mx-auto h-[1339px] overflow-hidden">
            <div className="relative mx-auto max-w-[1850.3px] border-4 border-red-500">
                <section
                    className="absolute top-[60px] left-[69.8px] rounded-tl-3xl rounded-tr-none rounded-b-none bg-whitesmoke-300 w-[1850.3px] h-[1276.6px]"
                />
                ...
                <section className="absolute top-[72px] left-[calc(50%_-_543.2px)] w-[1190px] flex flex-col items-start justify-start min-w-[700px] max-w-[1190px] px-4 text-left text-lg text-white-mode-main-text-color font-inter ">
