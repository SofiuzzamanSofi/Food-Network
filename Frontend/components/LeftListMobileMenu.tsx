...
type LeftListMobileMenuType = {
    ...
    leftListMobileMenuTop?: CSSProperties["top"];
    leftListMobileMenuLeft?: CSSProperties["left"];
};

const LeftListMobileMenu: NextPage<LeftListMobileMenuType> = ({
    name1,
    name2,
    name3,
    name4,
    ...
    const leftListMobileMenuStyle: CSSProperties = useMemo(() => {
        return {
            position: leftListMobileMenuPosition,
            top: leftListMobileMenuTop,
            left: leftListMobileMenuLeft,
        };
...
export default LeftListMobileMenu;