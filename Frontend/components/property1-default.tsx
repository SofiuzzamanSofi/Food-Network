...
const Property1Default: NextPage<Property1DefaultType> = ({
    ...
    return (
        <div
            className="rounded-mini bg-white w-[300px] h-[830px] flex flex-col items-center justify-start p-[15px] box-border gap-[15px] text-left text-xs text-tomato-100 font-inter z-50 shadow-lg"
